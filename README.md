...
Currently, it can only be used to serve generic PNG images generated server-side. I may add support for preloaded / clipped image in the future.
...
```html
<img src="http://www.autoimg.com/100/200"> 
